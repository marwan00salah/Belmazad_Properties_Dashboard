export function skeletonGrid(count = 8) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    card.className = "rounded-2xl bg-white shadow-sm border border-ink-100 overflow-hidden";
    card.innerHTML = `
      <div class="aspect-[4/3] bg-ink-100 shimmer"></div>
...
export function skeletonStats() {
  ...
  for (let i = 0; i < 4; i++) {
    ...
    t.className = "rounded-2xl bg-white shadow-sm p-4 border border-ink-100";
    t.innerHTML = `
